...
void SyncTime()
{
    ...
    twatch->SetRTCTime(timeinfo.tm_year + 1900, timeinfo.tm_mon, timeinfo.tm_mday, timeinfo.tm_hour, timeinfo.tm_min, timeinfo.tm_sec);
...
void setup()
{
    ...
    twatch->Botton_BindEvent(TWATCH_BTN_1, TWatchClass::Click, SyncTime);

    twatch->SetRTCTime(2022, 2, 19, 10, 56, 30);
}
