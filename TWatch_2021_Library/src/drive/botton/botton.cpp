...
void TWatch::Botton_Updata(uint32_t millis, uint32_t time_ms)
{
...
void TWatch::Botton_BindEvent(uint8_t Btn, uint8_t Event, callbackFunction Screen)
{
    OneButton *_btn;
    switch (Btn)
    {
