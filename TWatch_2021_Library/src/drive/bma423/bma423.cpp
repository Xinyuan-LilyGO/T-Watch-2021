...
void TWatch::AccSensor_Interface_Init()
{
...
bool TWatch::CheckAccSensor()
{
}

void TWatch::AccSensor_Updata(uint32_t millis, uint32_t time_ms)
{
...
void TWatch::AccSensor_OnStep(bool Step, bool Reset)
{
}

void TWatch::AccSensor_Sleep(bool Acc, bool Step)
{
}

void TWatch::AccSensor_GetStepValue(int32_t *val)
{
}

float TWatch::AccSensor_GetX() { return AccX; }
float TWatch::AccSensor_GetY() { return AccY; }
float TWatch::AccSensor_GetZ() { return AccZ; }

uint32_t TWatch::AccSensor_GetStep() { return stepCount; }
