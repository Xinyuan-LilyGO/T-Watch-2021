 ...
 * @defgroup bma423ExampleFIFOWH FIFO watermark header mode
 * @brief Example shows read fifo watermark data in header mode.
 * \include fifo_watermark_header_mode.c
 */
