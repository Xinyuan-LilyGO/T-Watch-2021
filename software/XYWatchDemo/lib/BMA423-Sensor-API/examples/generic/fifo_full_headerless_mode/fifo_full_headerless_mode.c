 ...
 * @defgroup bma423ExampleFIFOHL FIFO full headerless mode
 * @brief Example shows read fifo data in headerless mode.
 * \include fifo_full_headerless_mode.c
 */
 ...
 */
#define BMA423_FIFO_ACCEL_FRAME_COUNT     UINT8_C(170)
