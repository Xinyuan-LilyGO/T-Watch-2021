 ...
 * @defgroup bma423ExampleFIFOWHL FIFO watermark headerless mode
 * @brief Example shows read fifo watermark data in headerless mode.
...
#define BMA423_FIFO_WATERMARK_LEVEL       UINT16_C(600)
