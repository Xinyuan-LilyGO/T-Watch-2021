...
#ifndef LV_ATTRIBUTE_IMG_EXAMPLE_GIF
#define LV_ATTRIBUTE_IMG_EXAMPLE_GIF
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_EXAMPLE_GIF uint8_t example_gif_map[] = {
