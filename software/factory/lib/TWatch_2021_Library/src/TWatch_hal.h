...
#include "SD.h"
#endif
#if defined(CONFIG_TWATCH_HAS_SD) || defined(CONFIG_TWATCH_HAS_LFS)
#include "FS.h"
#endif
...
typedef enum { BUTTON_CLICK = 0,
               ...
               BUTTON_DURING_LONG_PRESS } button_event_t;
...
#if defined(CONFIG_TWATCH_HAS_LFS)
  /* LittleFS */
  bool lfs_init(bool formatOnFail = false, const char *basePath = LFS_MOUNT_POINT, uint8_t maxOpenFiles = 10,
